import flwr as fl
from flwr.common import Scalar, GetParametersIns, GetParametersRes, NDArrays
import torch
from typing import Dict
from collections import OrderedDict

from model import FNN, train, test
...
class FlowerClient(fl.client.NumPyClient):
    ...
    def __init__(self, trainloader, vallodaer, num_classes) -> None:
        ...
        #self.model = Autoencoder(num_classes, 15)
        self.model = FNN(num_classes, 12, output_size=1)
